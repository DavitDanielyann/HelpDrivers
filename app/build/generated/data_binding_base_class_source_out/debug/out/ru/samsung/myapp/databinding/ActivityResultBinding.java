...
public final class ActivityResultBinding implements ViewBinding {
  ...
  private ActivityResultBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnGoHome,
      @NonNull Button btnReview, @NonNull TextView resultText) {
  ...
  public static ActivityResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultBinding((ConstraintLayout) rootView, btnGoHome, btnReview,
          resultText);
    }
