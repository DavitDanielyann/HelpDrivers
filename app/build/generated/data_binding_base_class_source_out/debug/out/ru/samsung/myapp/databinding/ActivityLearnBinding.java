...
public final class ActivityLearnBinding implements ViewBinding {
  ...
  private ActivityLearnBinding(@NonNull ScrollView rootView, @NonNull LinearLayout learnLayout) {
    this.rootView = rootView;
    this.learnLayout = learnLayout;
  }
  ...
  public static ActivityLearnBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.learnLayout;
      LinearLayout learnLayout = ViewBindings.findChildViewById(rootView, id);
      if (learnLayout == null) {
        break missingId;
      }

      return new ActivityLearnBinding((ScrollView) rootView, learnLayout);
    }
